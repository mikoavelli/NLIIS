...
class MainApp:
    ...
    def initialize_system(self):
        """Initializes corpus stats and the file watcher."""
    ...
    def on_filesystem_change(self):
        """Callback for the watcher, safely schedules a UI update."""
        print("Main: File system change detected by watcher.")
    ...
    def setup_ui(self):
        ...
        # --- NEW: Bind double-click to open the file in the default text editor ---
    ...
    def refresh_file_list(self):
        """Re-initializes the entire system upon file changes."""
